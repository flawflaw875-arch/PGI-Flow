...
| ID | Operator       | Formula (Representative Definition)                                                                   | Trainable?                                              | Applicable Architectures (Specific)                                                                                                                                                                                           |
| -: | -------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|  0 | Conv_1x1       | $y_{o,h,w}=\sum_i W_{o,i}x_{i,h,w}+b_o$                                                               | Yes (W, b*)                                             | **All**                                                                                                                                                                                                                       |
|  1 | Conv_3x3       | $y_{o,h,w}=\sum_{i,u,v} W_{o,i,u,v}x_{i,h+u,w+v}+b_o$                                                 | Yes                                                     | **All**                                                                                                                                                                                                                       |
|  2 | Conv_3x3_DS    | stride=2: $y_{o,h,w}=\sum_{i,u,v} W_{o,i,u,v}x_{i,2h+u,2w+v}+b_o$                                     | Yes                                                     | **All** *(Stride-2 conv also exists in SSD extra layers)* ([mmdetection.readthedocs.io][1])                                                                                                                                   |
|  3 | Conv_7x7_DS    | stride=2 7×7 conv                                                                                     | Yes                                                     | **FR50/FR101/CR50/CR101/Retina**                                                                                                                                                                                              |
|  4 | Conv_3x3_Dil   | dilation $d$: reference $x_{i,h+d u,w+d v}$                                                           | Yes                                                     | **SSD** (MMDet SSDVGG includes dilation=6 conv)                                                                                                                                              |
...
|  7 | DWConv_5x5     | depthwise 5×5                                                                                         | Yes                                                     | **ED0, ED3** *(EfficientNet backbone commonly includes an MBConv stage with k=5)*                                                                                                                                             |
|  8 | DWConv_5x5_DS  | stride=2 depthwise 5×5                                                                                | Yes                                                     | **ED0, ED3**                                                                                                                                                                                                                  |
|  9 | MaxPool_2x2_DS | $y_{c,h,w}=\max_{(u,v)\in2\times2}x_{c,2h+u,2w+v}$                                                    | No                                                      | **SSD** (VGG pool1~ etc.)                                                                                                                                                                                                     |
| 10 | MaxPool_3x3    | (usually s=1) $y=\max_{(u,v)\in3\times3}x$                                                            | No                                                      | **SSD** (MMDet SSDVGG has k=3, s=1, p=1 maxpool)                                                                                                                                             |
| 11 | MaxPool_3x3_DS | stride=2 $y=\max x$                                                                                   | No                                                      | **FR50/FR101/CR50/CR101/Retina** (ResNet stem maxpool k=3, s=2, p=1)  / **ED0/ED3** (commonly used for downsampling in BiFPN)                                                                                    |
| 12 | MaxPool_5x5    | stride=1, pad=2 $y=\max_{5\times5}x$                                                                  | No                                                      | **Y5s/Y5x** (SPPF: MaxPool2d k=5, s=1, p=2)  / **Y8n/Y8m** (same Ultralytics SPPF implementation) / **X-s/X-l** (SPP kernel_sizes include 5) |
| 13 | MaxPool_9x9    | stride=1, pad=4                                                                                       | No                                                      | **X-s/X-l** (MMDet CSPDarknet SPP default kernel_sizes=(5,9,13))                                                                                                                             |
| 14 | MaxPool_13x13  | stride=1, pad=6                                                                                       | No                                                      | **X-s/X-l** (same)                                                                                                                                                                           |
| 15 | AvgPool_Global | $y_c=\frac{1}{HW}\sum_{h,w}x_{c,h,w}$                                                                 | No                                                      | **ED0/ED3** (SE, etc.)                                                                                                                                                                                                        |
| 16 | Upsample_2x    | nearest: $y_{c,2h+i,2w+j}=x_{c,h,w}$                                                                  | No                                                      | **Y8n/Y8m/Y5s/Y5x/X-s/X-l**, **FR/CR/Retina**, **ED0/ED3**                                                                                                                                                                    |
| 17 | RoIAlign_7x7   | bin sampling + bilinear: $y=\sum_p w_p,x(p)$                                                          | No                                                      | **FR50/FR101/CR50/CR101**                                                                                                                                                                                                     |
| 18 | BatchNorm      | $y=\gamma\frac{x-\mu}{\sqrt{\sigma^2+\epsilon}}+\beta$                                                | Yes ($\gamma,\beta$)                                    | **Y8/Y5/X**, **FR/CR**, **SSDLite**, **Retina** *(head BN may be included depending on implementation/config)*, **ED0/ED3**                                                                                                   |
| 19 | ReLU           | $y=\max(0,x)$                                                                                         | No                                                      | **FR/CR/Retina**, **SSD**, *(Included for ED0/ED3 if fast fusion uses ReLU to enforce non-negative fusion weights)*                                                                                     |
| 20 | ReLU6          | $y=\min(\max(0,x),6)$                                                                                 | No                                                      | **SSDLite**                                                                                                                                                                                                                   |
| 21 | SiLU           | $y=x\cdot\sigma(x)$                                                                                   | No                                                      | **Y8/Y5/X**, **ED0/ED3**                                                                                                                                                                                                      |
| 22 | Sigmoid        | $\sigma(x)=\frac{1}{1+e^{-x}}$                                                                        | No                                                      | **ED0/ED3** (SE gating, etc. — definitely inside the network)                                                                                                                                                                 |
| 23 | Add            | $y=x_1+x_2$                                                                                           | No                                                      | **Y8/Y5/X**, **FR/CR/Retina**, **SSDLite**, **ED0/ED3**                                                                                                                                                                       |
| 24 | Concat         | $y=\text{concat}(x_1,x_2,\dots)$ (channel-wise)                                                       | No                                                      | **Y8/Y5/X** *(required in CSP, PAN, SPP/SPPF)*                                                                                                                                                                                |
| 25 | Split_Channel  | $x\rightarrow (x^{(1)},x^{(2)})$ (channel split)                                                      | No                                                      | **Y8/Y5/X** *(required in CSP-style blocks)*                                                                                                                                                                                  |
| 26 | Mul            | $y=x_1\odot x_2$                                                                                      | No (op) / *(but the multiplied **w** can be trainable)* | **ED0/ED3** (SE, BiFPN weighted fusion)                                                                                                                                                                                       |
| 27 | Div            | $y=\frac{x_1}{x_2+\epsilon}$                                                                          | No                                                      | **ED0/ED3** (BiFPN fast normalized fusion: $w_i/(\epsilon+\sum w_j)$)                                                                                                                                   |
| 28 | Flatten        | $x\in\mathbb{R}^{C\times7\times7}\rightarrow \mathbb{R}^{C\cdot49}$                                   | No                                                      | **FR/CR**                                                                                                                                                                                                                     |
| 29 | Reshape        | Tensor shape change (values unchanged)                                                                | No                                                      | (Mostly can be pushed into **out**)                                                                                                                                                                                           |
| 30 | Linear         | $y=Wx+b$                                                                                              | Yes                                                     | **FR/CR** (RoI FC head)                                                                                                                                                                                                       |
| 31 | L2Norm         | (per spatial location) $y_{c,h,w}=s_c\frac{x_{c,h,w}}{\sqrt{\sum_{c'}x_{c',h,w}^2+\epsilon}}$         | **Yes** (per-channel $s_c$)                             | **SSD** (MMDet SSDVGG includes an L2Norm module + trainable weights)                                                                                                                         |
| 32 | out            | Final selection of detection outputs (Decode/NMS/TopK/Threshold/score normalization, etc.) as a whole | No (by definition)                                      | **All (common)**                                                                                                                                                                                                              |
