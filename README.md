...
|  2 | Conv_3x3_DS    | stride=2: $y_{o,h,w}=\sum_{i,u,v} W_{o,i,u,v}x_{i,2h+u,2w+v}+b_o$                                     | Yes                                                     | **All** *(Stride-2 conv also exists in SSD extra layers)*                                                                                                                                    |
...
| 29 | Reshape        | Tensor shape change (values unchanged)                                                                | No                                                      | **Y5**                                                                                                                                                                                           |
