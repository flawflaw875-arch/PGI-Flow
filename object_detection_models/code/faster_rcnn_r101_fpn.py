...
# ---------------------------------------------------------
# 2. ResNet/FPN/Head Component Builder
# ---------------------------------------------------------
...
def make_rpn_head(fm_id, name_prefix):
    ...
    cls_output = add_node("Sigmoid", [cls_conv], f"{name_prefix}_RPN_Cls_Sigmoid")
...
# ---------------------------------------------------------
# 3. Compose Architecture (Faster R-CNN R101-FPN)
# ---------------------------------------------------------
# ResNet-101 Block Counts: [3, 4, 23, 3]
...
# 4. Stage C4 (23 blocks) <-- R101 Depth
c4_out = make_resnet_stage(current_id, "C4", num_blocks=23)
current_id = c4_out
...
# 3. Fully Connected Layers (Two FC layers)
...
# ---------------------------------------------------------
graph_data = {
    "architecture": "Faster_R-CNN_R101_FPN",
...
file_path = "../Graph/faster_rcnn_r101_fpn_graph.json"
